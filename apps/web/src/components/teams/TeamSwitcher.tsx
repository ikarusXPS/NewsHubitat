...
export function TeamSwitcher() {
  ...
  // Show loading state briefly, but don't hide completely when no teams
          ...
          <div className="absolute top-full left-0 mt-2 w-64 bg-gray-800 border border-gray-700 rounded-lg shadow-xl z-50 py-2">
            ...
            {teams.length > 0 ? (
              ...
              <div className="px-4 py-3 text-center">
                ...
                <p className="text-xs text-gray-500 mt-1">{t('createFirstTeam', 'Create your first team to collaborate')}</p>
              </div>
            )}
