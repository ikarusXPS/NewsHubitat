...
export type TranscriptWhereInput = {
  ...
  contentId?: Prisma.StringFilter<"Transcript"> | string
  contentType?: Prisma.StringFilter<"Transcript"> | string
  ...
  provider?: Prisma.StringFilter<"Transcript"> | string
  transcribedAt?: Prisma.DateTimeFilter<"Transcript"> | Date | string
}
...
export type TranscriptOrderByWithRelationInput = {
  ...
  transcribedAt?: Prisma.SortOrder
}

export type TranscriptWhereUniqueInput = Prisma.AtLeast<{
  id?: string
  contentType_contentId?: Prisma.TranscriptContentTypeContentIdCompoundUniqueInput
  AND?: Prisma.TranscriptWhereInput | Prisma.TranscriptWhereInput[]
  OR?: Prisma.TranscriptWhereInput[]
  NOT?: Prisma.TranscriptWhereInput | Prisma.TranscriptWhereInput[]
  contentId?: Prisma.StringFilter<"Transcript"> | string
...
export type TranscriptScalarWhereWithAggregatesInput = {
  ...
  contentId?: Prisma.StringWithAggregatesFilter<"Transcript"> | string
  contentType?: Prisma.StringWithAggregatesFilter<"Transcript"> | string
  ...
  provider?: Prisma.StringWithAggregatesFilter<"Transcript"> | string
  transcribedAt?: Prisma.DateTimeWithAggregatesFilter<"Transcript"> | Date | string
}
...
export type TranscriptUpdateInput = {
  ...
  transcribedAt?: Prisma.DateTimeFieldUpdateOperationsInput | Date | string
}
...
export type TranscriptContentTypeContentIdCompoundUniqueInput = {
  contentType: string
  contentId: string
}
...
export type TranscriptOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "contentId" | "contentType" | "language" | "segments" | "fullText" | "provider" | "transcribedAt", ExtArgs["result"]["transcript"]>
...
export interface TranscriptFieldRefs {
  ...
  readonly contentId: Prisma.FieldRef<"Transcript", 'String'>
  readonly contentType: Prisma.FieldRef<"Transcript", 'String'>
  ...
  readonly provider: Prisma.FieldRef<"Transcript", 'String'>
  readonly transcribedAt: Prisma.FieldRef<"Transcript", 'DateTime'>
}
