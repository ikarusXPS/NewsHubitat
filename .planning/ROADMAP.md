...
### Phase 36.4 (INSERTED): Relocate Plan-03/04 monetization artifacts
...
Plans:
- [ ] 36.4-01-PLAN.md — Recover server-side tier middleware (requireTier.ts, aiTierLimiter, account/history/ai gates) — Wave 1, depends_on: []
- [ ] 36.4-02-PLAN.md — Recover client-side subscription components (TierCard, SubscriptionBadge, UpgradePrompt, AIUsageCounter) — Wave 1, depends_on: []
- [ ] 36.4-03-PLAN.md — Recover Pricing page + SubscriptionSuccess + routes + i18n (en/de/fr) — Wave 2, depends_on: [36.4-02]
- [ ] 36.4-04-PLAN.md — Verification gate: requireTier unit tests + manual D-09 probes + D-10 anti-pattern audit — Wave 3, depends_on: [36.4-01, 36.4-02, 36.4-03]
...
*Last updated: 2026-04-28 — Phase 36.4 (INSERTED) added: relocate-plan-03-04-monetization-artifacts. Phase 36.3 complete (5/5 plans: relocate + mount + orphan-sweep + E2E verification + anti-pattern markers); 93 [200] Stripe webhook forwards + IDEMPOTENCY: PASS empirically demonstrated; Plan 36-05 human-verify surfaced fourth wrong-path debt (Plan 03 tier middleware never relocated, Plan 04 UI deleted by 36.3 orphan sweep) → 36.4 inserted to close. Next: `/gsd-plan-phase 36.4`, then resume Plan 05 human-verify, then `/gsd-verify-phase 36.4 / 36.3 / 36.2`.*
